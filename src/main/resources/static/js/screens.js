...
export function renderStep(step) {
    if (step.type === "loader") {
        return `
            <img class="loader-art" src="/loader.svg?v=20260517-goal-loader" alt="GRINDY">
        `;
    }
    if (step.type === "welcome") {
        return `
            <img class="screen-art" src="/welcome-screen.svg?v=20260517-goal-loader" alt="Преврати цель в систему">
...
function yourPlanStep(step) {
    ...
    const art = hasEditedPlan
        ? "/Your%20Plan,%20Plan%20Changed.svg?v=20260517-goal-loader"
        : "/Your%20Plan.svg?v=20260517-goal-loader";
    return `
...
function planCorrectionStep(step) {
    ...
    return `
        <div class="your-plan-scroll is-dimmed">
            <img class="your-plan-art" src="/Your%20Plan.svg?v=20260517-goal-loader" alt="${escapeAttr(step.title)}">
            ${planOverlay(planForDisplay())}
            <span class="your-plan-scroll-spacer" aria-hidden="true"></span>
        </div>
        <button id="back" class="your-plan-back-hit-area" type="button" aria-label="Назад"></button>
...
function goalStep(step) {
    ...
    return `
        <img class="screen-art" src="/goal.svg?v=20260517-goal-loader" alt="Что будем достигать?">
...
function chooseGoalArt(index) {
    return [
        "/Choose%20the%20Goal.svg?v=20260517-goal-loader",
        "/Choose%20the%20Goal-2.svg?v=20260517-goal-loader",
        "/Choose%20the%20Goal-3.svg?v=20260517-goal-loader"
    ][index] || "/Choose%20the%20Goal.svg?v=20260517-goal-loader";
}
