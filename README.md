...
export GRINDY_AI_MODEL_LIGHT="gpt-4.1-nano"
export GRINDY_AI_MODEL_STANDARD="gpt-4.1-mini"
export GRINDY_AI_MODEL_STRONG="gpt-4.1"
```
...
```bash
AITUNNEL_API_KEY=sk-...
GRINDY_AI_MODEL_LIGHT=gpt-4.1-nano
GRINDY_AI_MODEL_STANDARD=gpt-4.1-mini
GRINDY_AI_MODEL_STRONG=gpt-4.1
